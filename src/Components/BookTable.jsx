...
function BookTable() {
 ...
 const [selectedPerson, setSelectedPerson] = useState(people[0])
  ...
  return (
    <div id="reservation" className="w-full bg-[#FFFBF2] py-20 px-6 sm:px-10 md:px-20">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center relative bg-[url('/images/bg.jpg')] bg-cover bg-center text-white p-8 md:p-12">
          ...
          <div className="relative z-10">
            ...
            <p className="text-sm sm:text-base leading-relaxed mb-6 text-white">
              Skip the wait and reserve your favorite spot at Koppee in just a few
              clicks. Whether you're planning a casual coffee date, a business
              meeting, or a solo chill session, we’ve got your seat ready. Book in
              advance to enjoy a seamless and personalized coffee experience.
            </p>
            <ul className="space-y-3 text-white text-sm sm:text-base font-bold">
              ...
              <li className="flex items-start gap-2">
                <span>✔</span> Brew moments that matter — we’ve saved you a seat.
              </li>
            </ul>
          </div>
        </div>
